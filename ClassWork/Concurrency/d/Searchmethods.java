...
public class Searchmethods {
  ...
  public static void main(String[] args) {
    ...
    String searchResult = map.search(
      3,
      (k, v) -> {
    ...
    String searchEntries = map.searchEntries(
      3,
      e -> {
    ...
    System.out.println("------------------------------------------");
    Integer searchKeys = map.searchKeys(
      3,
      k -> {
        if (k > 20) {
          return k;
    ...
    String searchValues = map.searchValues(
      3,
      v -> {
